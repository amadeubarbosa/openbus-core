...
ESTE MANUAL ESTÁ DESATUALIZADO. NÃO SIGA POR ELE, SÓ ESTÁ AQUI POR QUESTÕES DE
HISTÓRICO E PARA SERVIR DE INÍCIO DE UM NOVO MANUAL.

ENQUANTO ISSO, SIGA PELA DOCUMENTAÇÃO EXISTENTE EM:
\begin{itemize}
\item como instalar e executar o barramento:
\begin{itemize}
\item https://jira.tecgraf.puc-rio.br/confluence/display/ESDPUB/Documentos
\end{itemize}
\item como usar as ferramentas de empacotamento:
\begin{itemize}
\item https://jira.tecgraf.puc-rio.br/confluence/display/ESD/Ferramentas+para+Empacotamento
\end{itemize}
\end{itemize}
...
\subitem Lua (lce, filesystem, ldap e uuid).
...
filesystem & 1.4.2      & libs    & básicos  \\ \hline
...
install:
	install -m 644 lib/libtolua5.1.a $(INSTALL_TOP)/lib/
