...
\end{tabular}
\end{center}
\caption{Exempo de um mapa de validade de leases.}
\label{leasemap}
\end{table}%
...
corotinas) não é custoso, e é escalável...
...
\item Usuário executa aplicação v3o2. Através de um menu, inicia
  ...
  \item Nesse momento a aplicação v3o2 se conecta ao barramento OpenBUS.
     ...
     credencial relativa a sua autenticacão e pode obter a referência
  ...
  \item A conexão de um membro ao barramento não é suficiente para
     ...
     também serviços ``exportados'' por outros membros (localizaveis
...
\item v3o2 de posse do identificador do poço (obtido via VGE ou do
     ...
     perfuração (acesso a arquivos EXATA), poço ... (trajetoria está na
     base)
