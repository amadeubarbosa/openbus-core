...
renovação da credencial/sessão, para receber mensagens enviadas pela 
sessão e para ser avisado do "fechamento" da sessão.
...
\item Serviço de sessão (sessão) avisa ao Cliente 2 que sessão será encerrada
