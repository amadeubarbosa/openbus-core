...
classes SCS.IComponent e SCS.IMetaInterface.
Através da interface OpenBus.Member podemos descobrir as facetas que um membro
disponibiliza e obter referências para estas facetas. Tipicamente, um membro
disponibilizará seus serviços através destas facetas. Além disso, alguns
comportamentos opcionais dos membros serão implementados sob a forma de faceta
como, por exemplo, a habilidade de participar de sessões.

Dúvidas: 
\begin{itemize}
\item Vale a pena colocar o que é o SCS?
\end{itemize}
