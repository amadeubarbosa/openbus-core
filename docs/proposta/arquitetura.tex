...
mensagens quando algum evento ocorre na outra aplicação.
...
Através dele, um componente pode criar uma seção de
colaboração definir quem são os componentes participantes.
...
do v3o2, os atributos podem ser ... (Figura~\ref{fig:architecture}.)
