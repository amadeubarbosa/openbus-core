...
no mercado é a plataforma OpenSpirit \cite{openspirit}. O desenvolvimento dessa plataforma resultou de um consórcio
...
independente --- a OpenSpirit Corporation --- que conta com um grupo de investidores
...
o {\em OpenSpirit Runtime}, conectores de dados ({\em Data Connectors})
e adaptadores de aplicações ({\em Application Adapters}).
\begin{itemize}
...
O {\em toolkit} de desenvolvimento está 
...
diversas aplicações desenvolvidas pela Petrobras, como o SIGEO e o v3o2.
