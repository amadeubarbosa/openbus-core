...
por um cada tipo de repositório.
...
para os seguintes repositórios: OpenWorks/Seisworks, GeoFrame/IESX/Charisma,
Finder,
GOCAD, Kingdom, Petra,
...
OpenWorks/Seisworks e GeoFrame/IESX.
...
Linha webservice, SOA, JBI, Corba Services, openesb, serviços BEA
A adoção do {\em middleware} CORBA, com diversas implementações para diferentes
linguagens, tanto comerciais como abertas, permite a integração ...
