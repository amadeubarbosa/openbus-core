...
E\&P precisa integrar todas as aplicações utilizadas pelos usuários
nos seus fluxos de trabalho. Algumas aplicações já estão oferencendo
...
\item {\bf Dificuldade em integrar aplicações.}
