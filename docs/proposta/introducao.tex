...
seus dados. Como exemplo temos o WebSintesi que disponibiliza uma biblioteca
para acesso à sua área de projetos o e o Sigeo que possui um servidor que
possibilita às aplicações gravarem dados em sua área de projetos. O maior
problema dsse tipo de integração pontual é que o número de integrações tende a
se tornar exponencial (\(\frac{n(n-1)}{2}\)). Se quiséssemos integrar 10
aplicações, deveríamos implementar 45 integrações.
...
que a aplicação VGE acessa os dados da base e se quiser algum dado da
base - feições, por exemplo - terá de usar o VGE para obter esse dado
