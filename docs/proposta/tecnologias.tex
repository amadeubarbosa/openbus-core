...
e JacORB --- também contribuiram fortemente para o sucesso dessa arquitetura. 

Nos últimos anos observa-se, porém, uma significativa redução no 
uso de CORBA e o redirecionamento do mercado para outras tecnologias.
...
dentre eles escabilidade e desempenho.
...
provêm o suporte necessário para a implementação de uma arquitetura
