...
Maiores detalhes sobre a especificação e o uso do serviço de Registro de Ofertas podem ser encontrados nos seu manuais de uso das bibliotecas de acesso~\cite{sdk2.0.0-java,sdk2.0.0-cpp,sdk2.0.0-csharp,sdk2.0.0-lua}
...
\section{O \openbus{} para Administradores}

%explicar o uso dos binários 'busservices' e 'busadmin'
%busadmin


\section{O \openbus{} para Gerentes do barramento}
