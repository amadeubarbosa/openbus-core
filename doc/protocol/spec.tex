...
Similarmente à autenticação por senha, como resultado de um login por certificado bem sucedido, a operação \code{LoginByCertificate::login} devolve o identificador do login e o tempo mínimo pelo qual o login permanecerá válido sem necessidade de renovação.
