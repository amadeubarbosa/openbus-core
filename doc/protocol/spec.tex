...
As chaves RSA utilizadas para esse acesso devem ter tamanho de 2048 bits (256 bytes).
...
\begin{itemize}
	...
	\item 4 bytes em \term{little endian} com o valor do campo \code{request\_id} da mensagem GIOP ao qual a credencial está associada.
