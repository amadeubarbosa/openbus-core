...
\end{verbatim}
  ...
  Esse par de chaves deve ser criado utilizando o \emph{openssl}, que deve ser obtido previamente.
\begin{verbatim}
...
Assim como o script \code{businit}, o script \code{buscheck} também precisa ser alterado para indicar o local de instalação do barramento(variável \code{INSTALL\_DIR}).
