...
% TODO: explicar o significado dessas plataformas. Traduzir para uma nomenclatura conhecida.
...
\end{verbatim}
  ...
  \item Configurar a variável de ambiente LD\_LIBRARY\_PATH
\begin{verbatim}  
...
Informações sobre como configurar o validado LDAP do barramento podem ser encontradas em \cite{ob2.0ldap}.
