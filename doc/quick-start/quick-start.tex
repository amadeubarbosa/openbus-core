...
\end{verbatim}
  ...
  \item Criei um script de validação em LUA para verificar se o nome do usuário e senha utilizados para acessar o barramento são válidos. No nosso caso, vamos utilizar um script de validação que verifica apenas se o nome do usuário é igual à senha:
\begin{verbatim}  
  $ cd $OPENBUS_HOME
  $ vi validador.lua
