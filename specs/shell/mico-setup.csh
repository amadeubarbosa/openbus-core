...
setenv MICOVERSION ` sed -n '/MICO_VERSION/ { y/b/./; s#^[^"]*"\([^"]*\)".*$#\1#p; }' "$MICODIR/incpath/mico-2.3.13/${TEC_UNAME}/mico/version.h" `
...
setenv CPLUS_INCLUDE_PATH "$MICODIR/incpath/mico-2.3.13/${TEC_UNAME}:$CPLUS_INCLUDE_PATH"
