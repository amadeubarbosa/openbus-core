--
-- Testes unitários do Serviço de Controle de Acesso TOlerante a Falhas
--
require "oil"
local orb = oil.orb
...
Suite = {
  ...
  Test1 = {
    beforeTestCase = function(self)
      ...
      local CONF_DIR = os.getenv("OPENBUS_DATADIR").."/conf"
  ...
  Test2 = {
    ...
    testGetRegistryService = function(self)
      Check.assertNotEquals(nil,self.accessControlService:getRegistryService())
    end,
