...
public class HelloFTServer {
  public static void main(String[] args) throws Exception {
    ...
    // Acessa o OpenBus
    FTAccessControlServiceWrapper acs = new FTAccessControlServiceWrapper(orb);
    Registry.getInstance().setACS(acs);

    //boolean  res = acs.loginByCertificate("HelloService", privateKey, acsCertificate);
    boolean  res = acs.loginByPassword("tester", "tester");
